...
public class SpaceTrailParticle extends AnimationTrailParticle {
    ...
    protected SpaceTrailParticle(ClientLevel level, LivingEntityPatch<?> owner, Joint joint, AssetAccessor<? extends StaticAnimation> animation, TrailInfo trailInfo) {
