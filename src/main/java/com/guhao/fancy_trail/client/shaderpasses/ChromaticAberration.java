...
public class ChromaticAberration extends PostPassBase {
    ...
    public void process(RenderTarget inTarget, RenderTarget mask, RenderTarget outTarget, float strength) {
        ...
        this.effect.safeGetUniform("ChromaticStrength").set(strength);
