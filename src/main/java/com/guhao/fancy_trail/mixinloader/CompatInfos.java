package com.guhao.fancy_trail.mixinloader;
...
public class CompatInfos {
    ...
    public static boolean shouldMixin(String targetClassName, String mixinClassName_){
        ...
        if(CompatMixins.containsKey(MixinClassName.of(mixinClassName))){
            ...
            if(should) System.out.println("[FT Mixin Loader]Apply Compat Mixin: " + mixinClassName_ + ".class -> " + targetClassName + ".class");
            else System.out.println("[FT Mixin Loader]Skip Mixin: " + mixinClassName_ + ".class -> " + targetClassName + ".class");
            return should;
        }
        else {
            System.out.println("[FT Mixin Loader]Apply Default Mixin: " + mixinClassName_ + ".class -> " + targetClassName + ".class");
            return true;
        }
    }
}
