...
import com.inspiration_mushroom.fancy_trail.client.render.custom.BackgroundBlendRenderType;
...
@OnlyIn(Dist.CLIENT)
public class AAATrailParticle extends AnimationTrailParticle {

    private BackgroundBlendRenderType renderType;

    protected AAATrailParticle(ClientLevel level, LivingEntityPatch<?> owner,
                               Joint joint, AssetAccessor<? extends StaticAnimation> animation,
                               TrailInfo trailInfo) {
        super(level, owner, joint, animation, trailInfo);

        ResourceLocation texture = trailInfo.texturePath() != null
    ...
    public @NotNull ParticleRenderType getRenderType() {
        return renderType != null ? renderType : FTRenderType.strongBackgroundBlendRenderType(FTRenderType.NoneTexture);
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType typeIn, ClientLevel level,
            ...
            if (result.playable()) {
                return new AAATrailParticle(level, entitypatch,
